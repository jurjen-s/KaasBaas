...
-- Sat 28 Jan 2017 11:11:05 AM CET
...
CREATE TABLE IF NOT EXISTS `mydb`.`bestellingen` (
  ...
  `FK_bestellingen_adressen_id` INT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`bestellingregels` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`facturen` (
  ...
  INDEX `FK_klanten_id_idx` (`FK_facturen_klanten_id` ASC),
